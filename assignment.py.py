...
'''list0=[];list1=[];list3=[];list4=[];list5=[];list6=[];list7=[];list8=[];list2=[]
for i in range(12,33):
    data=sh1.cell(i,6).value
    if data==ls[0]:
        list0.append(sh1.cell(i,7).value)
        dict[ls[0]]=list0
    elif data==ls[1]:
        list1.append(sh1.cell(i,7).value)
        dict[ls[1]]=list1
    elif data==ls[2]:
        list2.append(sh1.cell(i,7).value)
        dict[ls[2]]=list2

    elif data==ls[3]:
        list3.append(sh1.cell(i,7).value)
        dict[ls[3]]=list3
    elif data==ls[4]:
        list4.append(sh1.cell(i,7).value)
        dict[ls[4]]=list4
    elif data==ls[5]:
        list5.append(sh1.cell(i,7).value)
        dict[ls[5]]=list5
    elif data==ls[6]:
        list6.append(sh1.cell(i,7).value)
        dict[ls[6]]=list6
    elif data==ls[7]:
        list7.append(sh1.cell(i,7).value)
        dict[ls[7]]=list7
    elif data==ls[8]:
        list8.append(sh1.cell(i,7).value)
        dict[ls[8]]=list8'''
dict2={}
